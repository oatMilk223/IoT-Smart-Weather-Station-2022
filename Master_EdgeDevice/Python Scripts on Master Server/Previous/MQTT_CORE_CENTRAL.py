        ...
        with db_connection.cursor() as cursor:
            ...
            if (result is None):
                sql = """CREATE TABLE weather_data_central(
                            ...
                            date DATE NOT NULL,
                            time TIME NOT NULL,
                            earthquake_duration INT NOT NULL,
                            earthquake_severity INT NOT NULL,
                            PRIMARY KEY(data_id)
                        );"""
    ...
    with db_connection:
        with db_connection.cursor() as cursor:
            ...
            sql = """INSERT INTO weather_data_central(date, time, earthquake_duration, earthquake_severity) VALUES (
                        CURDATE(), CURTIME(), '%s', '%s', '%s');""" % (SENSOR_DATA["earthquake_duration"]["value"], SENSOR_DATA["earthquake_severity"]["value"])
