...
import CENTRAL_MQTT_PUBLISHER
import CENTRAL_DISCORD_SUBSCRIBER
import threading
...
thread5 = threading.Thread(target = CENTRAL_MQTT_PUBLISHER.push_data_to_master)
thread6 = threading.Thread(target = CENTRAL_DISCORD_SUBSCRIBER.listen_for_commands_from_master)
